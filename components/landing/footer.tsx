  ...
  return (
    <>
      ...
      <div className="w-screen -mx-[calc((100vw-100%)/2)] text-center select-none leading-none pt-16 pb-6 md:pb-0 overflow-hidden bg-transparent relative z-10">
        <span className="text-[28vw] font-serif font-normal tracking-tighter block leading-[0.75] text-inverted-bg select-none whitespace-nowrap">
          MedPilot
        </span>
      </div>
      ...
      <footer className="inverted-footer bg-background text-foreground w-full min-h-[350px] md:h-[350px] pb-16 flex flex-col justify-between overflow-hidden -mt-6 relative z-0">
        <div className="max-w-7xl mx-auto px-6 w-full flex flex-col md:flex-row justify-between items-start gap-12 mt-8">
          ...
          <div className="flex flex-col gap-4 max-w-md">
            ...
            <div className="flex items-center gap-4 mt-2 text-muted-foreground">
              ...
              <a href="mailto:soporte@medicalappointments.com" className="hover:text-foreground transition-colors" aria-label="Email">
        ...
        <div className="max-w-7xl mx-auto px-6 w-full border-t border-border/60 pt-8 mt-12 md:mt-0 flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-muted-foreground font-sans">
          <p>
            &copy; {new Date().getFullYear()} MedPilot. Todos los derechos reservados.
          </p>
          <p className="flex items-center gap-1.5">
            Hecho con <Heart className="size-4 text-primary fill-primary animate-pulse" /> para profesionales de la salud.
          </p>
        </div>
      </footer>
    </>
